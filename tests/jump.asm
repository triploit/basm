main:			# basm needs a main
    ...
    jmp d_		# jump to function d_
    jmp main		# jump to function main (endless loop)
    hlt			# stop programm (will never be execute, due to the endless loop
d_:			# function d_
    push 2		# push 2 ti stack
    outl		# write last number of the stack and write a new line character
    pop			# delete last element from stack
    jmp e_		# jump to function e_
...
e_:			# function e_
    ...
    return		# return to d_ and load the value of GX to GX
