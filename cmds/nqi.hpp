...
class Nqi : public Command
{
private:
    std::regex name = std::regex("^((N|n)(Q|q)(I|i))");
...
public:
    void runFunction(std::vector<std::string> args)
    {
        ...
        {
            std::cout << "ERROR: LINE " << Runtime.LineNumber << ": NQI: INVALID_ARGUMENT_1: \"" << var1 << "\"" << std::endl;
            exit(1);
        }
        ...
        {
            std::cout << "ERROR: LINE " << Runtime.LineNumber << ": NQI: INVALID_ARGUMENT_2: \"" << var2 << "\"" << std::endl;
            exit(1);
        }
        ...
        {
            std::cout << "ERROR: LINE " << Runtime.LineNumber << ": NQI: INVALID_ARGUMENTS: \"" << var1 << "\"" << "/\"" << var2 << "\"" << std::endl;
            exit(1);
        }
    }
