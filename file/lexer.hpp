...
private:
    ...
    std::vector<std::vector<std::regex>> COMMANDS =
    {
        ...
        { // mov
            ...
            std::regex("(( *)(\\t*))*((M|m)(O|o)(V|v))( |\\t)(( *)(\\t*))([0-9]*|([A-Za-z0-9_]*)),(( *)(\\t*))([A-Za-z0-9_]*)(( *)(\\t*))(;|)( |((( *)(\\t*))|)#.*)*")
        },
        { // push
        ...
        { // add
            ...
            std::regex("(( *)(\\t*))*((A|a)(D|d)(D|d))( |\\t)(( *)(\\t*))([0-9]*|([A-Za-z0-9_]*)),((( *)(\\t*))|)([A-Za-z0-9_]*)(( *)(\\t*))(;|)( |((( *)(\\t*))|)#.*)*")
        },
        { // sub
            std::regex("(( *)(\\t*))*((S|s)(U|u)(B|b)).*"),
            std::regex("(( *)(\\t*))*((S|s)(U|u)(B|b))( |\\t)(( *)(\\t*))([0-9]*|([A-Za-z0-9_]*)),((( *)(\\t*))|)([A-Za-z0-9_]*)(( *)(\\t*))(;|)( |((( *)(\\t*))|)#.*)*")
        },
        { // mul
            std::regex("(( *)(\\t*))*((M|m)(U|u)(L|l)).*"),
            std::regex("(( *)(\\t*))*((M|m)(U|u)(L|l))( |\\t)(( *)(\\t*))([0-9]*|([A-Za-z0-9_]*)),((( *)(\\t*))|)([A-Za-z0-9_]*)(( *)(\\t*))(;|)( |((( *)(\\t*))|)#.*)*")
        },
        { // div
            std::regex("(( *)(\\t*))*((D|d)(I|i)(V|v)).*"),
            std::regex("(( *)(\\t*))*((D|d)(I|i)(V|v))( |\\t)(( *)(\\t*))([0-9]*|([A-Za-z0-9_]*)),((( *)(\\t*))|)([A-Za-z0-9_]*)(( *)(\\t*))(;|)( |((( *)(\\t*))|)#.*)*")
        },
        { // mod
            std::regex("(( *)(\\t*))*((M|m)(O|o)(D|d)).*"),
            std::regex("(( *)(\\t*))*((M|m)(O|o)(D|d))( |\\t)(( *)(\\t*))([0-9]*|([A-Za-z0-9_]*)),((( *)(\\t*))|)([A-Za-z0-9_]*)(( *)(\\t*))(;|)( |((( *)(\\t*))|)#.*)*")
        },
        { // hlt
        ...
        {
            std::regex("(( *)(\\t*))*([a-zA-Z0-9_]*).*"),
            std::regex("(( )*(\\t)*)*([a-zA-Z0-9_]*)(( )*(\\t)*)*[a-zA-Z0-9_]*(,(( )*(\\t)*)*[a-zA-Z0-9_]*)*")
        }
    };
